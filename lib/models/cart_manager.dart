...
import 'package:app_cantina_murialdo/services/cepaberto_service.dart';
...
class CartManager extends ChangeNotifier {
  ...
  Future<void> _loadCartClass() async{
    if(user.serie != null){
      class1 = user.serie;
      notifyListeners();
    }
  ...
  Future<void> _loadCartItems() async {
    ...
    items = cartSnap.documents
        .map((d) =>
            CartProduct.fromDocument(document: d)..addListener(_onItemUpdated))
        .toList();
  }
  ...
  bool get isAddressValid =>
      (address != null && deliveryPrice != null) || class1 != null;

  void getClass(String class1) {
    address = null;
    deliveryPrice = null;
    this.class1 = class1;
    user.serie = class1;
  ...
  Future<bool> calculateDelivery(double lat, double long) async {
    ...
    final maxdistance = doc.data['maxdistance'] as num;
